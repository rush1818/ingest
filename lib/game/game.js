...
import {BallPos, GameDims, WinPos, evilPos} from './utils.js';
...
class Game {
  ...
  checkWin(){
    if ((this.ball.pos[0] <= (this.winPos[0] + 10) && (this.ball.pos[0] >= this.winPos[0] - 10)) &&
     ((this.ball.pos[1] <= this.winPos[1] + 20) && this.ball.pos[1] >= this.winPos[1] - 20 )){
       this.levelWon = true;
    }
  }
